...
def FCN8_helper(nClasses, input_height, input_width, input_bands):
    ...
    o = Conv2DTranspose(filters=nClasses, kernel_size=(2, 2), strides=(2, 2), padding="valid", activation = "softmax", #activation=None,
                        name="score2")(o)
...
def FCN8(nClasses, input_height, input_width, input_bands):

    fcn8 = FCN8_helper(nClasses, input_height, input_width, input_bands)
