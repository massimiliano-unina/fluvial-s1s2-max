...
from segmentation_models import Unet,PSPNet,Linknet,FPN, Nestnet, Xnet
...
comb = ["VH","VV","VVaVH", "VVaVHaSum","VVaVHaRatio", "VVaVHaDiff","Total"]#"Ratio",  #["VVaVH"]#Ratio"]# ["VVaVH"]##
...
for combinations in range(len(comb)):
    ...
    for k_back in range(len(backs)):
        ...
        networks = ["Unet","Linknet","FPN"]#,"NestNet", "XNet"]# ["Unet"]#,"PSPNet","Linknet","FPN"]#["PSPNet","Linknet","FPN"]# 
