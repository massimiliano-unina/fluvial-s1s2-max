...
folder_out_2 = r"D:\Albufera_2019_processed\Training\Gamma\\"
...
#         # imsave(os.path.join(folder_out_2,'Y_val_' + str(final_out_2) + '.tif'),y_val_k)
#         # imsave(os.path.join(folder_out_2,'X_val_' + str(final_out_2) + '.tif'),x_gval_k)
#         final_out_2 += 1
#     #     n = n + 1
...
np.savez("test_data_SAR_Iodice_gamma_with_summer_augmentation.npz",x_gtest = x_gtest,y_test = y_test)#,  x_gtrain = x_gtrai y_train = y_trai  x_gval = x_gval, y_val = y_val)    
