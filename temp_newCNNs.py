...
n_batch = 32
LR_MAX = 0.005 # 0.02 # 
comb = ["Tri"]#  ["VV", "VH","VVaVH","Tri"] # ["VV", "VH","VVaVH", "Tri"] #  ["VV", "VH", , "VVaVHaSum","VVaVHaRatio", "VVaVHaDiff","Total"]#"Ratio",  #["VVaVH"]#Ratio"]# ["VVaVH"]##
...
########## file test 
        ...
        for combinations in comb:
            ...
            for k_back in range(len(backs)):
                ...
                networks = ["Unet"]#["Fractal_Net"] #  ["DenseUNet"]#["shallow_CNN"]# ["Fractal_Net", "FractalNet","shallow_CNN" , "Unet","Linknet","SegNet","FPN"] # ["SegNet","FPN"]#   "NestNet" "shallow_CNN"] #  ["SVM", "RF", "GBC", 
...
# print(dic)
            ...
            # ######## TRAINING ############
                    if k_mod == "SVM" or k_mod == "RF" or k_mod == "GBC" :
                        ...
                        # model.load_weights(date_2 + name_inputs + combinations + "_" + BACKBONE + "_" + name_model + "_model_wIoU"+ str(size) +".h5")
            ...
            #            
                        ...
                        model.save_weights( date_2 + name_inputs +combinations + "_2" + BACKBONE + "_" + name_model + "_model_wIoU"+ str(size) +".h5")
        ############END TRAINING#############           
                    ...
                    if k_mod == "SVM" or k_mod == "RF" or k_mod == "GBC": 
                        ...
                        model.load_weights(date_2 + name_inputs +combinations + "_2" + BACKBONE + "_" + name_model + "_model_wIoU"+ str(size) +".h5")
    ...
    # #########TESTING ############################
            ...
            #                 opt_test = Y1.astype('float32')
                            ...
                            path_results = r"C:\Users\massi\Downloads\segmentation_models-master\images\results_Metri2\\"
                            name_inputs1 = "Test_" + name_inputs
                            for k in range(0,10): #x_test2.shape[0],x_test2.shape[0]//10): #x_test2.shape[0]):#x_test.shape[0],int(x_test.shape[0]/100)): 
                                x_val_1 = x_test2[k,:,:,:]
                                y_val_1 = y_test1[k,:,:,:]
                                pred_val_1 = preds_val[k,:,:,:]
                                ...
                                ndvi = y_val_1.astype('float32')
                                im = path_results + name_inputs1 + combinations + "_" + BACKBONE+ date_2  + '_' + name_model + '_target_'+ str(k) + '_wpatches'+ str(size) +'.tif'
                                
                                imsave(im, ndvi)
                                
                                ndvi2 = pred_val_1.astype('float32')
                                im2 =  path_results + name_inputs1 + combinations + "_" + BACKBONE +date_2  + '_' + name_model + '_output_'+ str(k) + '_wpatches'+ str(size) +'.tif'
                                imsave(im2, ndvi2)
                                ...
                                if name_model.find("shallow") != -1: 
                                    ...
                                    im3 = path_results + combinations + "_" + BACKBONE + date_2  +'_' + name_model + '_NDVI_'+ str(k) + '_wpatches'+ str(size) +'.tif'
                                    imsave(im3, ndvi3)
                                    ndvi3 = opt_test_2[:,:].astype('float32')
                                    im3 = path_results + combinations + "_" + BACKBONE + date_2  +'_' + name_model + '_MNDWI_'+ str(k) + '_wpatches'+ str(size) +'.tif'
                                    imsave(im3, ndvi3)
                                    if N == 1: 
                                        ndvi3 = x_val_1[:,:,0].astype('float32')
                                        im3 = path_results + combinations + "_" + BACKBONE + date_2  +'_' + name_model + '_VV_'+ str(k) + '_wpatches'+ str(size) +'.tif'
                                        imsave(im3, ndvi3)
                                    elif N == 2:
                                        ndvi3 = x_val_1[:,:,0].astype('float32')
                                        im3 = path_results + combinations + "_" + BACKBONE + date_2  +'_' + name_model + '_VV_'+ str(k) + '_wpatches'+ str(size) +'.tif'
                                        ...
                                        im4 =  path_results + combinations + "_" + BACKBONE +date_2  + '_' + name_model + '_VH_'+ str(k) + '_wpatches'+ str(size) +'.tif'
                                        imsave(im4, ndvi4)
