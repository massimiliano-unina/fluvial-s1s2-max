...
# "C:\Users\massi\Downloads\sentinel1_Salerno\Albufera-20200415T192751Z-001\Albufera\File_Training\Input\Training\VV_26022020.tif"
# "C:\Users\massi\Downloads\sentinel1_Salerno\Albufera-20200415T192751Z-001\Albufera\File_Training\Input\Training\MNDWI_10022020.tif"
# "C:\Users\massi\Downloads\sentinel1_Salerno\Albufera-20200415T192751Z-001\Albufera\File_Training\Input\Training\MNDWI_15022018.tif"
# "C:\Users\massi\Downloads\sentinel1_Salerno\Albufera-20200415T192751Z-001\Albufera\File_Training\Input\Training\MNDWI_15022020.tif"
# "C:\Users\massi\Downloads\sentinel1_Salerno\Albufera-20200415T192751Z-001\Albufera\File_Training\Input\Training\MNDWI_20022018.tif"
# "C:\Users\massi\Downloads\sentinel1_Salerno\Albufera-20200415T192751Z-001\Albufera\File_Training\Input\Training\MNDWI_20022020.tif"
# "C:\Users\massi\Downloads\sentinel1_Salerno\Albufera-20200415T192751Z-001\Albufera\File_Training\Input\Training\MNDWI_25022020.tif"
# "C:\Users\massi\Downloads\sentinel1_Salerno\Albufera-20200415T192751Z-001\Albufera\File_Training\Input\Training\NDWI_10022020.tif"
# "C:\Users\massi\Downloads\sentinel1_Salerno\Albufera-20200415T192751Z-001\Albufera\File_Training\Input\Training\NDWI_15022018.tif"
# "C:\Users\massi\Downloads\sentinel1_Salerno\Albufera-20200415T192751Z-001\Albufera\File_Training\Input\Training\NDWI_15022020.tif"
# "C:\Users\massi\Downloads\sentinel1_Salerno\Albufera-20200415T192751Z-001\Albufera\File_Training\Input\Training\NDWI_20022018.tif"
# "C:\Users\massi\Downloads\sentinel1_Salerno\Albufera-20200415T192751Z-001\Albufera\File_Training\Input\Training\NDWI_20022020.tif"
# "C:\Users\massi\Downloads\sentinel1_Salerno\Albufera-20200415T192751Z-001\Albufera\File_Training\Input\Training\NDWI_25022020.tif"
# "C:\Users\massi\Downloads\sentinel1_Salerno\Albufera-20200415T192751Z-001\Albufera\File_Training\Input\Training\park.tif"
# "C:\Users\massi\Downloads\sentinel1_Salerno\Albufera-20200415T192751Z-001\Albufera\File_Training\Input\Training\VH_08022020.tif"
# "C:\Users\massi\Downloads\sentinel1_Salerno\Albufera-20200415T192751Z-001\Albufera\File_Training\Input\Training\VH_14022020.tif"
# "C:\Users\massi\Downloads\sentinel1_Salerno\Albufera-20200415T192751Z-001\Albufera\File_Training\Input\Training\VH_17022018.tif"
# "C:\Users\massi\Downloads\sentinel1_Salerno\Albufera-20200415T192751Z-001\Albufera\File_Training\Input\Training\VH_18022018.tif"
# "C:\Users\massi\Downloads\sentinel1_Salerno\Albufera-20200415T192751Z-001\Albufera\File_Training\Input\Training\VH_20022020.tif"
# "C:\Users\massi\Downloads\sentinel1_Salerno\Albufera-20200415T192751Z-001\Albufera\File_Training\Input\Training\VH_26022020.tif"
# "C:\Users\massi\Downloads\sentinel1_Salerno\Albufera-20200415T192751Z-001\Albufera\File_Training\Input\Training\VV_08022020.tif"
# "C:\Users\massi\Downloads\sentinel1_Salerno\Albufera-20200415T192751Z-001\Albufera\File_Training\Input\Training\VV_14022020.tif"
# "C:\Users\massi\Downloads\sentinel1_Salerno\Albufera-20200415T192751Z-001\Albufera\File_Training\Input\Training\VV_17022018.tif"
# "C:\Users\massi\Downloads\sentinel1_Salerno\Albufera-20200415T192751Z-001\Albufera\File_Training\Input\Training\VV_18022018.tif"
# "C:\Users\massi\Downloads\sentinel1_Salerno\Albufera-20200415T192751Z-001\Albufera\File_Training\Input\Training\VV_20022020.tif"
...
path = r"C:\Users\massi\Downloads\sentinel1_Salerno\Albufera-20200415T192751Z-001\Albufera\File_Training\Input\Training\\" #D:\Albufera_2019_processed\subset_albufera\Dataset\\"
folder_out_2 = r"C:\Users\massi\Downloads\sentinel1_Salerno\Albufera-20200415T192751Z-001\Albufera\File_Training\Input\MNDWI_NDWI\\"
...
for file in dir_list: 
    ...
    if file.find("_NDWI") != -1: 
        files_MNDWIp.append(file)
    if file.find("_MNDWI") != -1: 
        files_MMNDWIp.append(file)
# print(len(files_VV))
# print(len(files_VH))
print(len(files_gVV))
print(len(files_gVH))
...
for MNDWI_ind in range(len(files_MNDWIp)): 
    ...
    file_MMNDWIp = os.path.join(path, files_MMNDWIp[MNDWI_ind])
    ...
    dataset = None
    dataset = gdal.Open(file_MMNDWIp, gdal.GA_ReadOnly)
    mmndwip = dataset.ReadAsArray()
    dataset = None
    # dataset = gdal.Open(file_NDVIp, gdal.GA_ReadOnly)
    # ndvip = dataset.ReadAsArray()
    # dataset = None
    print(files_MNDWIp[MNDWI_ind])
    print(files_gVH[MNDWI_ind])
    print(files_gVV[MNDWI_ind])
...
#    #### other additional input   
    ...
    for patch in p_train:
        ...
        y_train_k[ :,:,0]= mndwip[y0:y0+ps, x0:x0+ps] 
        y_train_k[ :,:,1]= mmndwip[y0:y0+ps, x0:x0+ps]
         # np.invert()#-b6_r[y0+r:y0+ps-r, x0+r:x0+ps-r]
        y_train_k[ :,:,2]= 1-m_water[y0:y0+ps, x0:x0+ps] # np.invert()#-b6_r[y0+r:y0+ps-r, x0+r:x0+ps-r]
    ...
    for patch in p_val:
        ...
        y_val_k[ :,:,0]= mndwip[y0:y0+ps, x0:x0+ps]# np.invert(cndvi[y0:y0+ps, x0:x0+ps])#-b6_r[y0+r:y0+ps-r, x0+r:x0+ps-r]
        y_val_k[ :,:,1]= mmndwip[y0:y0+ps, x0:x0+ps]# np.invert(cndvi[y0:y0+ps, x0:x0+ps])#-b6_r[y0+r:y0+ps-r, x0+r:x0+ps-r]
        y_val_k[ :,:,2]= 1 - m_water[y0:y0+ps, x0:x0+ps]# np.invert(cndvi[y0:y0+ps, x0:x0+ps])#-b6_r[y0+r:y0+ps-r, x0+r:x0+ps-r]
...
imsave(os.path.join(folder_out_2,'Patches_train.tif'), train)
