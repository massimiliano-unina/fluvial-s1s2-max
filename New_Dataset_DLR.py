...
features = ["NDVI.", "corine_u8_c.", "geo_localthetainc.","geo_mean_gamma0dB.","geo_mean_rho6.","geo_rhoLT.","geo_tau."]
...
#            os.system(command) 
            ...
            if feature == "NDVI.":
                ndvi = np.asarray(add)
            elif feature == "corine_u8_c.":
                corine_4classes = np.asarray(add)
...
#        corine_INVALID = corine_4classes == 0
        ...
        mask_rhoLT = (rhoLT == 0 ) + (corine_4classes == 0)
        del corine_4classes
        ...
        if k1 < 3:
            ...
            for y in range(1,s1-ps+1,r): 
                for x in range(1,s2-ps+1,r):
                    ...
                    mask_d0_corine_ARTIFICIAL_SURFACES= corine_ARTIFICIAL_SURFACES[y:y+ps,x:x+ps]
                    mask_d0_corine_FOREST = corine_FOREST[y:y+ps,x:x+ps]
                    mask_d0_corine_NOFOREST = corine_NOFOREST[y:y+ps,x:x+ps]
                    [m1,m2] = mask_d0.shape
                    s_0 =  mask_d0.sum()
    ...
    #            else:
                ...
                y_train_k[n,:,:,0]= corine_ARTIFICIAL_SURFACES[y0:y0+ps, x0:x0+ps]#-b6_r[y0+r:y0+ps-r, x0+r:x0+ps-r]
                y_train_k[n,:,:,1] = corine_FOREST[y0:y0+ps, x0:x0+ps]#-b6_r[y0+r:y0+ps-r, x0+r:x0+ps-r]
                y_train_k[n,:,:,2] = corine_NOFOREST[y0:y0+ps, x0:x0+ps]#-b6_r[y0+r:y0+ps-r, x0+r:x0+ps-r]
    #                y_train_k[n,:,:,3] = corine_INVALID[y0:y0+ps, x0:x0+ps]#-b6_r[y0+r:y0+ps-r, x0+r:x0+ps-r]
            ...
            for patch in p_val:
                ...
                y_val_k[n,:,:,0] = corine_ARTIFICIAL_SURFACES[y0:y0+ps, x0:x0+ps]#-b6_r[y0+r:y0+ps-r, x0+r:x0+ps-r]
                y_val_k[n,:,:,1] = corine_FOREST[y0:y0+ps, x0:x0+ps]#-b6_r[y0+r:y0+ps-r, x0+r:x0+ps-r]
                y_val_k[n,:,:,2] = corine_NOFOREST[y0:y0+ps, x0:x0+ps]#-b6_r[y0+r:y0+ps-r, x0+r:x0+ps-r]
    #            y_val_k[n,:,:,3] = corine_INVALID[y0:y0+ps, x0:x0+ps]#-b6_r[y0+r:y0+ps-r, x0+r:x0+ps-r]
            ...
            for y in range(1,s1-ps1+1,r1): 
                for x in range(1,s2-ps1+1,r1):
                    ...
                    mask_d0_corine_ARTIFICIAL_SURFACES= corine_ARTIFICIAL_SURFACES[y:y+ps1,x:x+ps1]
                    mask_d0_corine_FOREST = corine_FOREST[y:y+ps1,x:x+ps1]
                    mask_d0_corine_NOFOREST = corine_NOFOREST[y:y+ps1,x:x+ps1]
                    [m1,m2] = mask_d0.shape
                    s_0 =  mask_d0.sum()
                    s_123 = [mask_d0_corine_ARTIFICIAL_SURFACES.sum(), mask_d0_corine_FOREST.sum(), mask_d0_corine_NOFOREST.sum() ]
                    materials = np.where(s_123 == np.max(s_123))[0][0]
...
#            random.shuffle(p)
            ...
            for patch in p_test:
                ...
                y_test_k[n,:,:,0]= corine_ARTIFICIAL_SURFACES[y0:y0+ps, x0:x0+ps]#-b6_r[y0+r:y0+ps-r, x0+r:x0+ps-r]
                y_test_k[n,:,:,1] = corine_FOREST[y0:y0+ps, x0:x0+ps]#-b6_r[y0+r:y0+ps-r, x0+r:x0+ps-r]
                y_test_k[n,:,:,2] = corine_NOFOREST[y0:y0+ps, x0:x0+ps]#-b6_r[y0+r:y0+ps-r, x0+r:x0+ps-r]
    #                y_train_k[n,:,:,3] = corine_INVALID[y0:y0+ps, x0:x0+ps]#-b6_r[y0+r:y0+ps-r, x0+r:x0+ps-r]
                n = n + 1
...
np.savez("train_data_HRL_RHO6_NDVI_aug_stride32_with_test_100.npz",x_test = x_test, y_test= y_test, x_train = x_train, y_train = y_train, x_val = x_val, y_val = y_val)    
